...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, ObjectProvider<InternalApiKeyFilter> internal) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(a -> a
                        ...
                        .access(new WebExpressionAuthorizationManager("hasAnyRole('ADMIN','MANAGER','ANALYST') or @trustedClientAuthorizer.isTrusted(authentication)"))
    ...
    public InternalApiKeyFilter internalApiKeyFilter(@Value("${security.internal-api-key:}") String apiKey){ return new InternalApiKeyFilter(apiKey, "ROLE_ADMIN"); }
