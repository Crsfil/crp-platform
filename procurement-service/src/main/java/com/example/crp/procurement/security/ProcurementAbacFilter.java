...
@Component
public class ProcurementAbacFilter extends OncePerRequestFilter {
    ...
    public ProcurementAbacFilter(ProcurementAbacProperties props, TrustedClientAuthorizer trustedClientAuthorizer) {
        this.props = props;
